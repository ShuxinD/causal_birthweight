---
title: "Grid Search Algorithm for Tree Methods in Generalized Propensity Score Model"
author: "Shuxin Dong"
date: "11/10/2020"
output: 
  html_document:
...
**Basic idea**: search for the best `ntrees` for each combination of `max_depth` and `col_sample_rate`
...
rep.bootstrap <- 50 # number of boostrap replicates
```

### 2. set the range of hyperparameters
...
### 4. fit Generalized Propensity Score (GPS) model, do prediction
...
### 5. do balance checking and find the optimal `n.trees`
