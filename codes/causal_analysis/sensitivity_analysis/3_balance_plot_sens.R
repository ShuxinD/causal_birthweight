...
# Code: (sensAnalysis) balance checking                                       #
...
dir_balancePlots <- "/media/gate/Shuxin/MAbirth/results/SensitivityAnalysis/3balancePlots/"
...
var <- c("sex", "married", "mage", 
         ...
         "bc_30d.wt", "bc_3090d.wt", "bc_90280d.wt",
         "no2_30d.wt", "no2_3090d.wt", "no2_90280d.wt")
var <- var[(var!="rf_db_gest") & (var!="rf_hbp_pregn") & (var!="m_wg_cat")]
