...
# opt_aac_i  <- optimize(F.aac.iter, interval = c(1, ncol(pred.gbm_exposure)), data = dt,
#                        ipw_num = ps.num, 
...
print(opt_aac)
write.csv(opt_aac, paste0(dir_gridsearch, "GridSearch_bc_all_two.csv"))
h2o.shutdown(prompt = FALSE)
...
print(opt_aac)
write.csv(opt_aac, paste0(dir_gridsearch, "GridSearch_no2_all_two.csv"))
h2o.shutdown(prompt = FALSE)
