...
dir_ipw <- "/media/qnap3/Shuxin/bc_no2_MAbirth_causal/data/ipw_whole_pregnancy/two_pollutant/"
...
## bwg ~ spline ----
dir_splines <- "/media/qnap3/Shuxin/bc_no2_MAbirth_causal/github_repo/results/2mainEffects/whole_pregnancy/two_pollutant/"
...
## bwg ~ exposure ----
dir_bwg <- "/media/qnap3/Shuxin/bc_no2_MAbirth_causal/github_repo/results/2mainEffects/whole_pregnancy/two_pollutant/"
exposures <- c("bc_all", "no2_all")
...
## lbw ~ exposure ----
dir_lbw <- "/media/qnap3/Shuxin/bc_no2_MAbirth_causal/github_repo/results/2mainEffects/whole_pregnancy/two_pollutant/"
exposures <- c("bc_all", "no2_all")
...
library(ggplot2)
library(stringr)
dir_balance <- "/media/qnap3/Shuxin/bc_no2_MAbirth_causal/github_repo/results/3balancePlots/whole_pregnancy/two_pollutant/"
