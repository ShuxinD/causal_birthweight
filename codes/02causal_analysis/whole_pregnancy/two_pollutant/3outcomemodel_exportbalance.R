...
dir_ipw <- "/media/qnap3/Shuxin/airPollution_MAbirth/data/ipw_whole_pregnancy/two_pollutant/"
...
## bwg ~ spline ----
dir_splines <- "/media/qnap3/Shuxin/airPollution_MAbirth/causal_birthweight/results/2mainEffects/whole_pregnancy/two_pollutant/"
...
## bwg ~ exposure ----
dir_bwg <- "/media/qnap3/Shuxin/airPollution_MAbirth/causal_birthweight/results/2mainEffects/whole_pregnancy/two_pollutant/"
exposures <- c("bc_all", "no2_all")
...
## lbw ~ exposure ----
dir_lbw <- "/media/qnap3/Shuxin/airPollution_MAbirth/causal_birthweight/results/2mainEffects/whole_pregnancy/two_pollutant/"
exposures <- c("bc_all", "no2_all")
...
library(ggplot2)
library(stringr)
dir_balance <- "/media/qnap3/Shuxin/airPollution_MAbirth/causal_birthweight/results/3balancePlots/whole_pregnancy/two_pollutant/"
...
balance_plot <- ggplot(balance[weighted!="weighted_glm",], aes(x = name.x, y = corr, group = weighted, colour = weighted)) +
  ...
  scale_x_discrete(labels = c("year" = "Birth year (cat.)",
                              ...
                              "no2_all" = "Average of daily NO[2] exposure over whole pregnancy (cont.)",
                              "bc_all" = "Average of daily BC exposure over whole pregnancy (cont.)")) + 
