...
dir_gridsearch <- "/media/qnap3/Shuxin/airPollution_MAbirth/causal_birthweight/results/1GridSearchResults/whole_pregnancy/single_pollutant/"
dir_ipwraw <- "/media/qnap3/Shuxin/airPollution_MAbirth/data/ipw_whole_pregnancy/single_pollutant/"
...
gs_bc_all <- fread(paste0(dir_gridsearch, "GridSearch_bc_all_single.csv"))
gs_no2_all <- fread(paste0(dir_gridsearch, "GridSearch_no2_all_single.csv"))
...
dir_plot <- "/media/qnap3/Shuxin/airPollution_MAbirth/causal_birthweight/results/3balancePlots/whole_pregnancy/single_pollutant/two_method/"
...
IPWs <- data.table(uniqueid_yr = birth[,uniqueid_yr],
                   ...
                   ipw_gbm_no2_all,
                   ipw_glm_no2_all)
fwrite(IPWs, file = "/media/qnap3/Shuxin/airPollution_MAbirth/data/ipw_whole_pregnancy/single_pollutant/IPWs_all_truncated.csv")
