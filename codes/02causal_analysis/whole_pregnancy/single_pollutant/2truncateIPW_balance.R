...
dir_gridsearch <- "/media/qnap3/Shuxin/bc_no2_MAbirth_causal/github_repo/results/1GridSearchResults/whole_pregnancy/single_pollutant/"
dir_ipwraw <- "/media/qnap3/Shuxin/bc_no2_MAbirth_causal/data/ipw_whole_pregnancy/single_pollutant/"
...
dir_plot <- "/media/qnap3/Shuxin/bc_no2_MAbirth_causal/github_repo/results/3balancePlots/whole_pregnancy/single_pollutant/two_method/"
...
IPWs <- data.table(uniqueid_yr = birth[,uniqueid_yr],
                   ...
                   ipw_gbm_no2_all,
                   ipw_glm_no2_all)
fwrite(IPWs, file = "/media/qnap3/Shuxin/bc_no2_MAbirth_causal/data/ipw_whole_pregnancy/single_pollutant/IPWs_all_truncated.csv")
