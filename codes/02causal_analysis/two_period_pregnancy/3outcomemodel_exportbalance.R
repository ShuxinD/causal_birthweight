...
dir_ipw <- "/media/qnap3/Shuxin/airPollution_MAbirth/data/ipw_two_periods/"
...
## load IPWs ----
IPWs <- fread(paste0(dir_ipw, "IPWs_two_periods_1108.csv"))
...
## bwg ~ spline ----
dir_splines <- "/media/qnap3/Shuxin/airPollution_MAbirth/causal_birthweight/results/4mainEffects/two_periods_analysis/"
...
## bwg ~ exposure ----
dir_bwg <- "/media/qnap3/Shuxin/airPollution_MAbirth/causal_birthweight/results/4mainEffects/two_periods_analysis/"
exposures <- c("bc_30d", "bc_30280d", "no2_30d", "no2_30280d")
...
write.csv(results_glm.bwg, file = paste0(dir_bwg, "results_two_periods_bwg.csv"))

## lbw ~ exposure ----
dir_lbw <- "/media/qnap3/Shuxin/airPollution_MAbirth/causal_birthweight/results/4mainEffects/two_periods_analysis/"
exposures <- c("bc_30d", "bc_30280d", "no2_30d", "no2_30280d")
...
write.csv(results_glm.lbw, file = paste0(dir_lbw, "results_two_periods_lbw.csv"))

## export balance ----
dir_balance <- "/media/qnap3/Shuxin/airPollution_MAbirth/causal_birthweight/results/3balancePlots/two_periods_analysis/"
